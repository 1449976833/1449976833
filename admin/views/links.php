...
<thead>
      ...
      <th class="tdcenter"><b>#</b></th>
        ...
        <th width="100" class="tdcenter"><b>操作</b></th>
      </tr>
    </thead>
    <tbody>
    <?php 
...
<a href="javascript:void(0);" id="select_all">全选</a>    丨   <a href="javascript:linkact('del');" class="care">删除</a>    丨  
	<a href="javascript:linkact('hide');">隐藏</a>    丨  
    <a href="javascript:linkact('show');">显示</a> &emsp;  
 ...
 <div class="list_footer">
  ...
  <input name="operate" id="operate" value="" type="hidden" />
      ...
      <a href="#addlink" data-toggle="modal" class="btn btn-success">新增链接</a>
</div>
</form>
<div class="row">
<div class="col-sm-12">
...
<h4 class="modal-title" id="addlinkLabel">新增链接</h4>
</div>
...
<label class="col-lg-2 control-label">描述</label>
    ...
    <textarea name="description" type="text" class="form-control" style="height:60px;overflow:auto;"></textarea>
            	...
            	<div class="form-group">
            	<div class="col-lg-10"> 
<input type="submit" class="btn btn-primary" name="" value="确定添加"  onclick="check_url()" /></div>
</div>
</div>					
</form>
</div>
