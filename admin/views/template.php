...
<a class="btn btn-primary" href="template.php?action=usetpl&tpl=<?php echo $value['tplfile']; ?>&side=<?php echo $value['sidebar']; ?>&token=<?php echo LoginAuth::genToken(); ?>">启用</a>&emsp;<a class="btn btn-info" href="../?theme=<?php echo $value['tplfile']; ?>" target="_blank">预览</a>
</div>
</div>
</div>
</div>
