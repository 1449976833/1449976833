...
<li class="active" role="presentation"><a aria-expanded="true" data-toggle="tab" role="tab" id="custom_tab" href="#custom"> 自定义导航 </a>
</li>
<li role="presentation" class=""><a data-toggle="tab" id="sort_tab" role="tab" href="#sort" aria-expanded="false"> 分类导航 </a></li>
<li role="presentation" class=""><a data-toggle="tab" id="page_tab" role="tab" href="#page" aria-expanded="false"> 页面导航 </a></li>
</ul>
</div>
<div class="panel-wrapper collapse in">
<div class="panel-body">
...
<label>父导航
 ...
 <div class="form-group"> 
<input type="checkbox" style="vertical-align:-3px;" value="y" name="newtab" />
<label>新窗口打开</label>
</div>
<div class="form-group">	
<input type="submit" class="btn btn-primary" name="" value="确定添加"  />
</div>
 </form>
</div>
...
<form action="navbar.php?action=add_sort" method="post" name="navi" id="navi">      
  ...
  if ($value['pid'] != 0) {
    ...
    ?>
<div class="form-group form-inline">
<input type="checkbox" style="vertical-align:-3px;" name="sort_ids[]" value="<?php echo $value['sid']; ?>" class="ids" />
...
<input type="submit" style="vertical-align:-3px;" name="" class="btn btn-info"  value="确定添加"  />
</div>
  <?php else:?>
<div class="form-group form-inline">
...
<form action="navbar.php?action=add_page" method="post" name="navi" id="navi">			
	...
	?>
<div class="form-group form-inline">
        <input type="checkbox" style="vertical-align:-3px;" name="pages[<?php echo $value['gid']; ?>]" value="<?php echo $value['title']; ?>" class="ids" />
	<label ><?php echo $value['title']; ?></label>
</div>
	<?php endforeach;?>
	<div class="form-group" style="padding-top:10px">	
	<input type="submit" name="" class="btn btn-success"  value="确定添加"  />
	</div>
	<?php else:?>
