...
<tbody>
    ...
    ?>
     <tr>
        ...
        <td width="350px"><a href="<?php echo Url::log($value['gid'])."#comment-".$value["cid"]; ?>" title="<?php echo $value['content']; ?>"><?php echo $sub_content; ?></a> 	<?php echo $ishide; ?>
        ...
        <?php endif;?>
        <a href="<?php echo Url::log($value['gid'])."#comment-".$value["cid"]; ?>">回复</a>
...
<div class="clearfix"></div>						
    ...
    <a href="javascript:void(0);" id="select_all">全选</a>    丨   <a href="javascript:commentact('del');" class="care">删除</a>   丨  
    <a href="javascript:commentact('hide');">隐藏</a>   丨  
