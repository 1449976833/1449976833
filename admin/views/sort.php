...
<thead>
            <tr>
                ...
                <th class="tdcenter"  width="90px"><b>操作</b></th>
            </tr>
        </thead>
        <tbody>
            <?php
...
<?php endif; ?>  
    ...
    <div class="list_footer">
        ...
        <a href="#addsort" data-toggle="modal" class="btn btn-success">新增分类</a>
    </div>
</form>
</div>
</div>
...
<h4 class="modal-title" id="addsortLabel">新增分类</h4>
</div>
...
<label class="col-lg-2 control-label">描述</label>
   ...
   <input type="submit" class="btn btn-primary" name="" id="addsort" value="确认添加" /></div>
   </div>					
 </form>
</div>
</div>
