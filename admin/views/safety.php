...
<a href="safety.php" class="waves-effect waves-light">站点防御</a>
</li>
</ul>
</div>
...
<div class="panel-body">
 ...
 <label>
<input value="1" style="vertical-align:-3px" name="webscan_switch" type="checkbox"   id="webscan_switch" <?php echo $webscan_switch; ?> />
启用防跨站攻击漏洞脚本<sup>(推荐火力全开,就是全选)</sup>
</label>
<br>
 <label>
<input value="1" style="vertical-align:-3px" name="webscan_post" type="checkbox"   id="webscan_post" <?php echo $webscan_post; ?> />
拦截POST方式
</label>
<br>
 <label>
<input value="1" style="vertical-align:-3px" name="webscan_get" type="checkbox"   id="webscan_get" <?php echo $webscan_get; ?> />
拦截GET方式
</label>
<br>
 <label>
<input value="1" style="vertical-align:-3px" name="webscan_cookie" type="checkbox"   id="webscan_cookie" <?php echo $webscan_cookie; ?> />
拦截COOKIE方式
</label>
<br>
 <label>
<input value="1" style="vertical-align:-3px" name="webscan_referre" type="checkbox"   id="webscan_referre" <?php echo $webscan_referre; ?> />
拦截REFERRE方式
</label>
</div>
        <div class="form-group">
...
<thead>
 ...
 <?php   
	...
	$pageurl =  pagination($count['num'],$pagenum,$page,"safety.php?plugin=block_ip-master&page=");
...
<?php } ?>         
<?php else: ?>      
 <tr><td class="tdcenter" colspan="3">近期非常安全没人攻击你的小博客</td></tr>
   <?php endif ?>   
    </tbody>
</table>
</div>
