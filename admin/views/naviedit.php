...
<a href="navbar.php" class="waves-effect waves-light">导航编辑</a>
</li>
</ul>
</div>
...
<label> 导航地址 </label>
    ...
    <div class="form-group">
    <div class="checkbox">
        <label><input type="checkbox" style="vertical-align:-3px" value="y" name="newtab" <?php echo $conf_newtab; ?> /> 在新窗口打开</label>
    </div>
    </div>
