...
<thead>
      <tr>
		...
		<th width="130px" class="tdcenter"><b>操作</b></th>
      </tr>
	...
	?>
     ...
     <?php 
		...
		<?php else:?>
		<center><a href="blogger.php">编辑</a></center>
		<?php endif;?></td>
...
<a href="#adduser" data-toggle="modal" class="btn btn-success">新增用户</a>
  </div>
</form>
...
<div class="form-group">
<label class="col-lg-2 control-label"> 密码（ 大于六位 ）</label>
<div class="col-lg-10"> 
...
<input name="token" id="token" value="<?php echo LoginAuth::genToken(); ?>" type="hidden" />
 <input type="submit" class="btn btn-primary" name="" value="确认添加"  />
 </div>	
 </div>					
</form>
</div>
