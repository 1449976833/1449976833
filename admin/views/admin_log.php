...
<a href="admin_log.php" class="waves-effect waves-light"> <?php if ($pid != 'draft'){ ?>全部文章<?php }else{ ?>临时草稿<?php } ?></a>
</li>
</ul>
</div>
...
<div class="clearfix"></div>						
 <input name="token" id="token" value="<?php echo LoginAuth::genToken(); ?>" type="hidden" />
    ...
    <a href="javascript:void(0);" id="select_all">全选</a>   丨  <a href="javascript:logact('del');" class="care">删除</a>    丨  
    <?php if($pid == 'draft'): ?>
    <a href="javascript:logact('pub');">发布</a>&emsp;
    <?php else: ?>
    <a href="javascript:logact('hide');">转稿</a> &emsp;
     <?php endif;?>
