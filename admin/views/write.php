...
<div class="col-lg-4 container-side">
    <div class="panel panel-default">
        <div class="panel-heading">设置选项</div>
...
<select name="sort" id="sort" class="form-control">
 ...
 <div class="form-group">
            <label> <a href="javascript:displayToggle('tagbox', 0);">选择标签</a> </label>
...
<div class="form-group">
  <label>转载地址</label>
  <input name="copyurl" id="copyurl" class="form-control" placeholder="输入原文地址，原创直接忽略" value="<?php echo $copyurl;?>" />
  </div>
            <div class="form-group">
            <label>发布时间</label>
       ...
       <div class="form-group">
            ...
            <div class="form-group">
            <input type="checkbox" style="vertical-align:-3px" value="y" name="top" id="top" <?php echo $is_top; ?> />
            <label for="top">首页置顶</label>&emsp;
            <input type="checkbox" style="vertical-align:-3px" value="y" name="sortop" id="sortop" <?php echo $is_sortop; ?> />
            <label for="sortop">分类置顶</label>&emsp;
            <input type="checkbox" style="vertical-align:-3px" value="y" name="allow_remark" id="allow_remark" checked="checked" <?php echo $is_allow_remark; ?> />
...
loadEditor('editor_content');
loadEditor('editor_excerpt');
function GetData(data){document.getElementById("thumbs").value=data;}
