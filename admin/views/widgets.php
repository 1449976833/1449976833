...
<div class=" form-group form-inline" >
                    ...
                    <?php endforeach; ?>
<p style="margin:20px 0px;"><a href="#custom_new" data-toggle="modal" class="btn btn-success">新增组件</a></p>
...
<h4 class="modal-title" id="custom_newLabel"> 新增组件 </h4>
</div>
...
<p class="col-lg-12"> 内容（ 支持HTML ） </p>
   ...
   <textarea name="new_content" class="form-control" rows="10" style="width:100%;overflow:auto;"></textarea>
            	...
            	<div class="form-group">
            	<div class="col-lg-10"> 
<input type="submit" class="btn btn-primary" name="" value="确定添加"  /></div>
</div>
</div>					
</form>
</div>
