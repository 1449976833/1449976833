...
<thead>
    <tr>
      ...
      <th width="87" class="tdcenter"><b>操作</b></th>
    </tr>
  </head>
  <tbody>
    <?php
...
<a href="javascript:void(0);" id="select_all">全选</a>     丨   <a href="javascript:bakact('del');" class="care">删除</a></div>
</div>
</form>
</div>
</div>
...
<div class="form-group">
 ...
 <option value="local" selected="selected"> 本地（ 手机/电脑 ） </option>
  <option value="server"> 服务器空间 </option>
        </select>
    </div>
<div class="form-group">
<input type="checkbox" style="vertical-align:-3px;" value="y" name="zipbak" id="zipbak">
...
<div class="form-group">
  ...
  <div class="form-group text-center">      
        <input type="submit" value="导入数据" class="btn btn-warning" />
</div>
</form>
</div>
</div>
