...
<div class="panel-body">
    <form action="configure.php?action=mod_config" method="post" name="input" id="input">
        ...
        <div class="form-group">
            ...
            <div class="checkbox">
                <label>
                    <input type="checkbox" value="y" name="detect_url" id="detect_url" <?php echo $conf_detect_url; ?> />自动检测站点地址（ 可能和部分CDN不兼容 ）
                </label>
            </div>
        </div>
        </div>
